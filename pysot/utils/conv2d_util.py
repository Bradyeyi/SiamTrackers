...
def testCon2dPSvf(input, kernel,bias=None, stride=1, padding=0, dilation=1, groups=1):
    kernel_size = tuple(kernel.shape[-2:])
    stride = _pair(stride)
    padding = _pair(padding)
    dilation = _pair(dilation)
...
def testCon2dSvf(input, kernel,bias=None, stride=1, padding=0, dilation=1, groups=1):
    kernel_size = tuple(kernel.shape[-2:])
    stride = _pair(stride)
    padding = _pair(padding)
    dilation = _pair(dilation)
