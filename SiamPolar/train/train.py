...
from SiamPolar.siampolar_net import Model
from SiamPolar.datasets.siampolar_dataset import TrkDataset
# from SiamFCOS.siampolar import Model
# from SiamFCOS.datasets.dataset import TrkDataset
...
def build_data_loader():
    logger.info("build train datasets")
    # train_dataset
